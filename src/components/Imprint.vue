<template>
  <div id="imprint">
    ...
    <div class="columns is-centered is-gapless px-5 mb-6">
      <div class="column is-6-tablet">
        ...
        <p>
          ...
          E-Mail:
          <a href="mailto:scheller@phogrow3d.com" class="has-text-grey-dark"
            >scheller@phogrow3d.com</a
          ><br />
        </p>
        <br />
        <p>
        ...
        <a href="https://www.impressum-generator.de" class="has-text-grey-dark"
